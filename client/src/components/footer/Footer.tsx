      ...
      <div className="container py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">EduAble</span>
            </div>
            <p className="mt-4 text-gray-400">
              Making education accessible to everyone through innovative technology and inclusive design.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <a href="#" className="text-base text-gray-400 hover:text-white">For Teachers</a>
              </li>
              <li>
                <a href="#" className="text-base text-gray-400 hover:text-white">For Students</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-base text-gray-400">
            &copy; {new Date().getFullYear()} EduAble. All rights reserved.
          </p>
          <nav className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-sm text-gray-400 hover:text-white">Privacy Policy</a>
            <a href="#" className="text-sm text-gray-400 hover:text-white">Terms of Service</a>
            <a href="#" className="text-sm text-gray-400 hover:text-white">Accessibility Statement</a>
          </nav>
        </div>
      </div>
    </footer>
